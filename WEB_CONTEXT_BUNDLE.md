...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-562-three-chromatic-0-2-graphs-38201bbc-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-562"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-562-three-chromatic-0-2-graphs-38201bbc-v1",
      "problem_contract_sha256": "861eb3ce874989e5c38e447376680a27751a8d7fee30b90dafe4d5da875167bd",
      "problem_id": "problem:um-opg-562-three-chromatic-0-2-graphs-38201bbc",
      "route_id": "route:um-opg-562-three-chromatic-0-2-graphs-38201bbc-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-562-three-chromatic-0-2-graphs-38201bbc-source-fidelity-01",
      "graph_id": "graph:um-opg-562-three-chromatic-0-2-graphs-38201bbc-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-562-three-chromatic-0-2-graphs-38201bbc-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-562-three-chromatic-0-2-graphs-38201bbc-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Question Are there any (0,2)-graphs with chromatic number exactly three?"
          },
          "statement_sha256": "df87e84b516c8ec7628e4daff36930613905e17452b6c747cceee1fd530c3bb5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-562-three-chromatic-0-2-graphs-38201bbc-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-562-three-chromatic-0-2-graphs-38201bbc-root",
      "route_id": "route:um-opg-562-three-chromatic-0-2-graphs-38201bbc-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-562-0bf2f0ff5e05",
        "url": "https://www.unsolvedmath.com/problems/OPG-562"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
